...
LATEST_VERSION=$(npx --yes kubernetes-fluent-client@latest --version 2>/dev/null)
RAW_NIGHTLY_VERSION=$(npx --yes kubernetes-fluent-client@nightly --version 2>/dev/null || echo "none")
